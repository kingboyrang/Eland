...
// 取得指定的項目設定 - GET
#define SingleCaseSettingURL @"http://60.251.51.217/Pushs.Admin/WebServices/CaseSetting.aspx?action=2&guid=%@"
// 取得设定的所有類別 - GET
#define CaseCategoryURL @"http://60.251.51.217/Cases.Admin/WebServices/CaseCategory.aspx"
// 查询项目 - POST
#define CaseSearchURL @"http://60.251.51.217/Pushs.Admin/WebServices/CaseSearch.aspx"
// 取得项目 - GET
#define SingleCaseURL @"http://60.251.51.217/Pushs.Admin/WebServices/CaseFind.aspx?guid=%@&pwd=%@"
// 新增项目 - POST
#define AddCaseURL @"http://60.251.51.217/Cases.Admin/WebServices/CaseAdd.aspx"

//图片浏览地址
#define CaseImageViewURL @"http://60.251.51.217/Pushs.Admin/%@"
